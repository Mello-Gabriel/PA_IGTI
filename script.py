...
textos=[texto.split('\\')[-1].split('.')[0] for texto in glob.glob(r'text_files/*.txt')]
tabelas=[tabela.split('\\')[-1].split('.')[0] for tabela in glob.glob(r'tabela_palavras/*.csv')]
