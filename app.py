...
with col1:
    ...
    st.plotly_chart(fig)
    top1=top_similares(palavras, empresa, 1)
    st.write("A empresa que possui o relatório mais similar é:", top1[0][1])
...
with col2:
    ...
    fig= px.histogram(tabela, x=tabela.index, y='quantidade')
    st.plotly_chart(fig)
    top2=top_similares(palavras, empresa2, 1)
    st.write("A empresa que possui o relatório mais similar é:", top2[0][1])
