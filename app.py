...
with st.expander('NAVEGADOR DE PALAVRAS E EMPRESAS'):
    st.write('Utilize essa rede de relacionamento para xplorar as relações entre as empresas através das palavras de seus relatórios. As empresas são representadas pelos pontos coloridos e as palavras pelos pontos cinzas')
